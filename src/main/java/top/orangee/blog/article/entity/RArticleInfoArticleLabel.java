...
@TableName("r_article_info_article_label")
@ApiModel(value="RArticleInfoArticleLabel对象", description="")
public class RArticleInfoArticleLabel implements Serializable {
